...
echo "$($PSQL "SELECT teams.name FROM teams FULL JOIN games ON teams.team_id = games.winner_id OR teams.team_id = games.opponent_id WHERE YEAR = 2014 AND ROUND = 'Eighth-Final' ORDER BY teams.name")"
